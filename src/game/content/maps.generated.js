export const GENERATED_MAP_MODULES = {
  ...
  "./maps/pinecut-pass/pinecut-pass-stage-1.json": {
    ...
    "units": [
      {
        "id": "pinecut-pass-stage-1-player-runner-9-1",
        "unitTypeId": "runner",
        "owner": "player",
        "level": 1,
        "x": 9,
      ...
      {
        "id": "pinecut-pass-stage-1-player-breaker-6-2",
        "unitTypeId": "breaker",
        "owner": "player",
        "level": 1,
        "x": 6,
      ...
      {
        "id": "pinecut-pass-stage-1-player-longshot-17-3",
        "unitTypeId": "longshot",
        "owner": "player",
        "level": 1,
        "x": 17,
      ...
      {
        "id": "pinecut-pass-stage-1-player-grunt-16-4",
        "unitTypeId": "grunt",
        "owner": "player",
        "level": 1,
        "x": 16,
      ...
      {
        "id": "pinecut-pass-stage-1-player-breaker-5-4",
        "unitTypeId": "breaker",
        "owner": "player",
        "level": 1,
        "x": 5,
      ...
      {
        "id": "pinecut-pass-stage-1-player-mechanic-8-4",
        "unitTypeId": "mechanic",
        "owner": "player",
        "level": 1,
        "x": 8,
  ...
  "./maps/stone-citadel/stone-citadel-stage-1.json": {
    ...
    "units": [
      ...
      {
        "id": "stone-citadel-stage-1-enemy-runner-13-8",
        "unitTypeId": "runner",
        "owner": "enemy",
        "level": 1,
        "x": 13,
